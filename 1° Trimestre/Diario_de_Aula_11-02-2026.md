...
6- As empresas trabalham em equipes. A parte teórica é mais importante, pois é um resumo da prática. As avaliações costumam ser periódicas, possibilitando o acompanhamento e refinamento do projeto. Entregas parciais são melhores para ter um melhor 
desenvolvimento, no entanto, entregas únicas são menos "irritantes" em relação às parciais.
